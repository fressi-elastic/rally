...
# from esrally.client import common, context
from esrally.client import context
...
class RallyAsyncElasticsearch(AsyncElasticsearch, context.RequestContextHolder):
